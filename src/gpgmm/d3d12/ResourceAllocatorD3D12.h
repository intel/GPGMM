    ...
    */
    ...
    class GPGMM_EXPORT ResourceAllocator final : public MemoryAllocator, public IUnknownImpl {
      public:
        ...
        @param resourceAllocatorOut Pointer to a memory block that recieves a pointer to the
        ...
        */
        ...
        @param resourceAllocationOut Pointer to a memory block that recieves a pointer to the
