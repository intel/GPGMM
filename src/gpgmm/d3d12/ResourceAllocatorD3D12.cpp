...
namespace gpgmm { namespace d3d12 {
    namespace {
        ...
        D3D12_RESOURCE_ALLOCATION_INFO GetResourceAllocationInfo(
            ...
            if (resourceDescriptor.Alignment != 0 &&
                ...
                d3d12::RecordLogMessage(LogSeverity::Debug,
        ...
        HRESULT TryAllocateResource(MemoryAllocator* allocator,
            ...
            if (allocation == nullptr) {
                d3d12::RecordLogMessage(LogSeverity::Debug, "ResourceAllocator.TryAllocateResource",
    ...
    HRESULT ResourceAllocator::CreateResource(const ALLOCATION_DESC& allocationDescriptor,
        ...
        RecordEvent<CREATE_RESOURCE_DESC>("ResourceAllocator.CreateResource", allocationDescriptor,
        ...
        if (!mIsAlwaysCommitted) {
            d3d12::RecordLogMessage(LogSeverity::Debug, "ResourceAllocator.CreateResource",
