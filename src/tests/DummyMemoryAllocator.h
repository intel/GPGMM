...
#ifndef SRC_TESTS_DUMMYMEMORYALLOCATOR_H_
#define SRC_TESTS_DUMMYMEMORYALLOCATOR_H_
...
namespace gpgmm {
    ...
    class DummyMemory : public MemoryBase {
      public:
...
#endif  // SRC_TESTS_DUMMYMEMORYALLOCATOR_H_
