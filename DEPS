...
deps = {
  ...
  'third_party/googletest': {
    'url': '{chromium_git}/external/github.com/google/googletest@15460959cbbfa20e66ef0b5ab497367e47fc0a04',
    'condition': 'gpgmm_standalone',
  },
  'third_party/vulkan-deps': {
    'url': '{chromium_git}/vulkan-deps@db66b99e13173a179ae50061430cfe214c454bd2',
    'condition': 'gpgmm_standalone',
  },
  # Dependency of //testing
  'third_party/catapult': {
    'url': '{chromium_git}/catapult.git@c083518eecae6cecd78e0b63ab7288231e4e7788',
    'condition': 'gpgmm_standalone',
  },
