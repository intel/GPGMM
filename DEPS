...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build@079e692ae2439092703bb420144d47a2588c32a2',
    'condition': 'gpgmm_standalone',
  },
  'buildtools': {
    'url': '{chromium_git}/chromium/src/buildtools@edbefcee3d2cc45cdb0c60c2b01b673f8ba728bc',
    'condition': 'gpgmm_standalone',
  },
  ...
  'buildtools/third_party/libc++/trunk': {
    'url': '{chromium_git}/external/github.com/llvm/llvm-project/libcxx.git@8d325feddafa88cda60c1f390099763c0c01dc1e',
    'condition': 'gpgmm_standalone',
  },
  'buildtools/third_party/libc++abi/trunk': {
    'url': '{chromium_git}/external/github.com/llvm/llvm-project/libcxxabi.git@970b5e6ec63ad4cca4f37afbc9cd081ce75be71e',
    'condition': 'gpgmm_standalone',
  },
  'tools/clang': {
    'url': '{chromium_git}/chromium/src/tools/clang@a2fa65fc8cdd3e971298d9625d4c41d0a70ac8c1',
    'condition': 'gpgmm_standalone',
  },
 'third_party/ninja': {
    'packages': [{
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@e72b926fbadbf69e91025a232ba706a541d69cd5',
    'condition': 'gpgmm_standalone',
  },
  'third_party/googletest': {
    'url': '{chromium_git}/external/github.com/google/googletest@45804691223635953f311cf31a10c632553bbfc3',
    'condition': 'gpgmm_standalone',
  },
  'third_party/vulkan-deps': {
    'url': '{chromium_git}/vulkan-deps@6e41699c8a41d9bb068e681437b363f5d57fb1e5',
    'condition': 'gpgmm_standalone',
  },
  # Dependency of //testing
  'third_party/catapult': {
    'url': '{chromium_git}/catapult.git@da83d8eafdc4cc7ae8dd1d95169ccf28b886ccf8',
    'condition': 'gpgmm_standalone',
  },
